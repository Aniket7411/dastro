...
function AdminDashboard() {
  ...
  const statCards = [
    ...
    { accent: 'bg-emerald-500', iconBg: 'bg-emerald-50', iconColor: 'text-emerald-600', icon: 'fa-newspaper',           badge: 'Published',  value: stats.activeArticles || stats.activeBlogs?.value || stats.activeBlogs || 0,           label: 'Active Articles',  barWidth: '65%', onClick: () => setActiveTab('blogs') },
