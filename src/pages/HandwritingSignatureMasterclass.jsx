  ...
  return (
    <div className={`${WB_PAGE_SHELL} flex flex-col min-h-screen bg-slate-50`}>
      <SEO
        ...
        description="Sirf 2 din mein handwriting aur signature se personality padhna seekhiye. Live on Zoom with Damini Shukla. Recording + PDF notes included. Rs 499 only."
