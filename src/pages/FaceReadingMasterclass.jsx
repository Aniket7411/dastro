  ...
  return (
    <div className={`${WB_PAGE_SHELL} flex flex-col min-h-screen bg-slate-50`}>
      <SEO
        ...
        description="Learn to decode anyone's personality through their face. 2-day live face reading masterclass (Samudrika Shastra) with Damini Shukla – Recording included. Enroll for ₹499."
