  ...
  return (
    <div className={`${WB_PAGE_SHELL} flex flex-col min-h-screen bg-slate-50`}>
      <SEO
        ...
        description="Sirf 2 din mein apni kundli khud padhna seekhiye - Lagna, 9 grahas, 12 bhavas aur The 3-Layer Reading Formula. Live on Zoom with Damini Shukla. Recording + PDF notes. Rs 499 only."
