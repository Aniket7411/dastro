export default function CourseHero({
  ...
  if (heroImg) {
    return (
      <header className="relative mb-4 w-full overflow-hidden border-b border-site-accent-dark/10 sm:mb-5">
        <img
          src={heroImg}
          alt={heading}
        ...
        <div className="absolute inset-0 z-10 mx-auto flex w-full max-w-[90rem] flex-col justify-end px-4 pb-6 sm:px-6 sm:pb-8 lg:px-12">
