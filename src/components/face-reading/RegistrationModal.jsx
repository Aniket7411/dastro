            ...
            <div className="grid md:grid-cols-2">
              <div className="bg-gradient-to-br from-[#3B2261] to-[#2a1845] p-6 text-white sm:p-8">
                ...
                <p className={`${TYPE.bodySmOnDark} mb-5`}>
                  Learn to decode anyone’s personality through their face in just 2 days.
                </p>
                <ul className="m-0 space-y-2.5 p-0">
                  {[
                    '2 Days Live Training on Zoom',
                    '160+ Snapshot Technique',
              ...
              <div className="p-5 sm:p-6">
                <div className="mb-5">
                  ...
                  <p className={TYPE.bodySm}>Limited Seats Available at ₹499/- (Launch Offer)</p>
                </div>
