  ...
  const days = [
    {
      ...
      items: [
        'What is Samudrika Shastra & the Golden Rule of reading',
        'The 3-Zone Face Map',
        '4 Face Shapes & Forehead Decode',
        'Eye Reading + Live Self-Reading Practice',
      ],
      delay: undefined,
    },
    {
      day: 'DAY 2',
      title: 'Reading the Complete Person',
      items: [
        'Nose, Lips & Ears Decode',
        'Moles (Til): The Right-Left Rule',
        'Voice, Walk & Body Language',
        'The 5-Step Snapshot Method + Full Live Reading Demo',
      ],
      delay: '200',
    },
  ];
