      ...
      <div className="mx-auto max-w-[920px]">
        <div className="relative overflow-hidden rounded-[18px] border border-[#ff9b42]/35 bg-[#100617] text-white shadow-[0_18px_60px_rgba(0,0,0,0.55),0_0_34px_rgba(255,81,60,0.28)] sm:rounded-[22px]">
          ...
          <div className="relative z-10 p-3 sm:p-4">
            ...
            <div className="mt-3 grid grid-cols-2 gap-2 sm:gap-3 min-[760px]:grid-cols-[1.08fr_0.92fr]">
              <div className="flex min-h-[82px] items-center justify-center rounded-[16px] border border-[#ff8b55]/25 bg-[#0b0613]/90 px-2 py-3 shadow-[inset_0_0_22px_rgba(255,112,57,0.08)] sm:min-h-[112px] sm:rounded-[20px] sm:px-4">
              ...
              <div className="relative mt-2 flex min-h-[82px] items-center justify-between overflow-visible rounded-[16px] border border-[#ff7a3a]/70 bg-[#1d092b] px-2.5 pb-3 pt-5 shadow-[0_0_22px_rgba(255,93,47,0.35)] sm:mt-0 sm:min-h-[112px] sm:rounded-[20px] sm:px-5 sm:pb-3 sm:pt-5">
