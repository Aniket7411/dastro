...
function FaqSection() {
  ...
  const faqs = [
    ...
    },
    {
      ...
      a: 'Teen cheezein - apni janm date, apna janm samay aur janm sthan; apni kundli (chart); aur ek notebook-pen. Chart aap free mein AstroSage par bana sakte hain - registration ke baad hamari team aapko step-by-step bata degi ki kaise nikalna hai. Chart class ke time saamne rakhiye, kyunki aap usi par live practice karenge.',
    },
    {
      q: 'Mujhe apna exact janm samay nahi pata - kya main join kar sakta hoon?',
      a: 'Haan. Seekhne ke liye approximate time se bhi kaam chal jaata hai - poora system aapko waise hi samajh aayega. Bas ye jaan lijiye ki accurate personal reading ke liye exact birth time zaroori hota hai, isliye ghar se puchh kar rakh lijiye to behtar.',
    },
    {
    ...
    },
    {
      ...
      a: 'Haan. Dono din ki recording aapko di jaati hai, saath mein dono din ke PDF notes aur chart worksheet bhi.',
    },
    {
      q: 'Kya mujhe pehle se astrology aani chahiye?',
      a: 'Bilkul nahi. Ye masterclass zero se shuru hoti hai - hum maan kar chalte hain ki aapne kabhi kundli khol kar dekhi hi nahi.',
    },
    {
      q: 'Kya certificate milega?',
      a: 'Is 2-din ki masterclass ka certificate nahi milta - ye ek practical learning session hai. Aapko recording, PDF notes aur worksheet milte hain.',
    },
    {
      q: 'Fee kitni hai?',
      a: '₹500 (MRP ₹1,999). Isme dono live sessions, recording, PDF notes aur worksheet shamil hain.',
    },
  ];
