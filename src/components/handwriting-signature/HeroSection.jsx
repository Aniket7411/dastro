    ...
    <section className={`relative ${WB_SECTION_HERO}`}>
      <div className={WB_WRAP}>
        ...
        <div className="mx-auto w-full max-w-3xl text-center" data-aos="fade-up">
          ...
          <p className={`${TYPE.lead} mx-auto max-w-[34ch] text-center mt-4 sm:mt-5 sm:max-w-[52ch] text-slate-900 sm:text-lg font-semibold`} data-aos="fade-up" data-aos-delay="100">
            Kisi ki bhi handwriting aur signature dekhkar uski Personality, Behaviour, Strengths aur Hidden Traits pehchaniye - sirf 2 din mein.
          </p>
          <p className={`mx-auto max-w-[34ch] text-center mt-3 sm:mt-4 sm:max-w-[52ch] text-slate-600 sm:text-base text-sm`} data-aos="fade-up" data-aos-delay="150">
