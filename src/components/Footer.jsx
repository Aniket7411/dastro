  ...
  const socialLinks = [
    {
      ...
      color: '#0084FF',
      link: settings?.facebookUrl || 'https://www.facebook.com/dsastrounfiltered/',
    },
    {
      name: 'Instagram',
      icon: (
    ...
    // X/Twitter — no confirmed account handle yet. Re-enable once we have a real twitterUrl.
    // {
    //   name: 'X',
    //   icon: (
...

    {
      ...
      color: '#FF0000',
      link: settings?.youtubeUnfilteredUrl || 'https://www.youtube.com/@dsastrounfiltered',
    },
    {
      name: 'WhatsApp',
