...
export default function FuturisticBottomCTA({ onJoinNow, isModalOpen = false }) {
  ...
  return (
    <div className={`fixed inset-x-0 bottom-0 z-50 transform-gpu px-2 pb-2 will-change-transform transition-[opacity,transform] duration-500 ease-[cubic-bezier(0.16,1,0.3,1)] sm:px-4 sm:pb-4 ${isPanelVisible ? 'translate-y-0 opacity-100' : 'translate-y-[115%] opacity-0'}`}>
          ...
          <div className="relative z-10 p-3 sm:p-4">
            ...
            <div className="mt-3 grid grid-cols-2 items-stretch gap-2 sm:gap-3 min-[760px]:grid-cols-[1.08fr_0.92fr]">
              ...
              <div className="relative flex min-h-[78px] items-center justify-between self-stretch overflow-visible rounded-[16px] border border-[#ff7a3a]/70 bg-[#1d092b] px-2.5 pb-2 pt-5 shadow-[0_0_22px_rgba(255,93,47,0.35)] sm:min-h-[112px] sm:rounded-[20px] sm:px-5 sm:pb-3 sm:pt-5">
                ...
                <button type="button" onClick={() => onJoinNow?.()} className="group relative ml-2 inline-flex h-9 w-9 flex-none items-center justify-center rounded-full border border-[#ffad56]/60 bg-[#2b1037] text-[#ffd482] shadow-[0_0_18px_rgba(255,134,54,0.62),inset_0_0_14px_rgba(255,148,54,0.14)] transition duration-200 hover:scale-105 hover:bg-[#3a1647] active:scale-95 min-[380px]:h-10 min-[380px]:w-10 sm:ml-3 sm:h-16 sm:w-16" aria-label="Join Masterclass Now">
