...
function ValueInclusionsBand() {
  const inclusions = [
    ...
    { text: 'Apne chaaron numbers aur apna Lo Shu grid class ke andar live', icon: 'fa-calculator' },
    { text: 'Apne mobile number ka analysis - aur wo method jisse aap kisi ka bhi number padh sakein', icon: 'fa-mobile-alt' },
