  ...
  const faqs = [
    {
      ...
      a: 'Masterclass 2 din chalti hai, roz 2 ghante, shaam ko, live on Zoom. Hum batches regularly chalate hain - aapki exact batch date aur timing registration ke turant baad WhatsApp par share ki jaati hai. Hamari team aapko call karke slot personally confirm bhi karti hai.',
    },
    {
    ...
    },
    {
      ...
      a: 'Apni date of birth, apna poora naam jaise aap likhte hain, apna mobile number, aur ek notebook-pen. Do-teen family members ki date of birth bhi rakh lijiye - Day 1 ka homework unke grids banane ka hai.',
    },
    {
      q: 'Kya mujhe apna janm samay chahiye?',
      a: 'Nahi. Numerology mein sirf date of birth chahiye - janm samay aur janm sthan ki zarurat nahi padti. Yehi cheez numerology ko sabse tez seekhne wali vidya banati hai.',
    },
    {
      q: 'Kya class mein mera naam theek karke diya jaayega?',
      a: 'Is masterclass mein aap apna name number nikalna seekhenge aur samjhenge ki aapka naam aapke driver number ke saath kaam kar raha hai ya nahi. Name correction - yaani spelling badalne ki methodology - is 2-din ki class ka hissa nahi hai.',
    },
    {
          ...
          {faqs.map((faq, idx) => {
            ...
            return (
              ...
              >
                ...
                <div className={`overflow-hidden bg-white transition-all duration-300 ease-out ${isOpen ? 'max-h-80 opacity-100' : 'max-h-0 opacity-0'}`}>
