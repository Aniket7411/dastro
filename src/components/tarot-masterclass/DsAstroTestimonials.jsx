...
const CONTENT = {
  ...
  messages: [
    ...
    { name: 'Sunita', phone: '***** 3390', date: '', chat: [{ side: 'them', text: 'Damini Maam ka padhane ka tarika bahut simple hai. Ek baar mein samajh aa jaata hai.', time: '1:44 pm' }] },
    { name: 'Rakesh', phone: '***** 8827', date: '', chat: [{ side: 'them', text: 'Mujhe laga tha ye sab bahut complicated hoga. Do din mein confidence aa gaya.', time: '8:47 pm' }] },
    { name: 'Neha', phone: '***** 6142', date: '', chat: [{ side: 'them', text: 'Maam live course ki details bhej dijiye please. Aage seekhna hai.', time: '6:29 pm' }] },
    { name: 'Vikas', phone: '***** 4008', date: '', chat: [{ side: 'them', text: 'Team ne call karke batch confirm kiya tha, bilkul waise hi hua. Setup professional hai.', time: '9:55 pm' }] },
    { name: 'Priya', phone: '***** 7263', date: '', chat: [{ side: 'them', text: 'Class ke baad group mein sawal poocha tha, Maam ne jawab bhi diya. Yehi acchi baat hai.', time: '3:21 pm' }] },
    { name: 'Ravi', phone: '***** 9471', date: '', chat: [{ side: 'them', text: 'I joined out of curiosity, but now I want to do the full live course. Please share the details.', time: '7:08 pm' }] },
    { name: 'Meena', phone: '***** 2605', date: '', chat: [{ side: 'them', text: 'Papa ke liye bhi join karwana chahti hoon, unko ye sab bahut pasand hai.', time: '10:15 pm' }] },
    { name: 'Sanjay', phone: '***** 5518', date: '', chat: [{ side: 'them', text: 'Do ghante kaise nikal gaye pata hi nahi chala. Live demo wala part sabse accha laga.', time: '9:20 am' }] },
    { name: 'Kavita', phone: '***** 3391', date: '', chat: [{ side: 'them', text: 'Maam ne mera example live liya tha class mein. Ghar mein sabko dikhaya 😄', time: '8:49 pm' }] },
  ],
};
